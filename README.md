...
# 制作背景
  ...
  その男の子はゲームが大好きです。ものすごい集中力を発揮して自ら攻略本を読み、どんどんクリアしていきます。  
...
## 訂正及びご連絡 2021.8.11追記
~~- Eメール : test1@test.com~~  
課題作成用ユーザーのアドレスを掲載させてしまっておりました。  
~~test1@test.com~~のメールアドレスでログインした場合、課題選択できない状態となってしまいます。  
こちらは問題作成機能を実装している都合上、ユーザー自身が簡単な問題を作成した上で、獲得経験値を多く設定してレベル上げに不正を働けない様に考慮したものです。
改めまして、下記しますアカウントにて挙動確認頂けます様よろしくお願いします。
## テスト用アカウント
- Eメール : test2@test.com
- パスワード : 111111
...
トップページ下部に課題を配置済み。遊び心でonマウス時にバックグラウンドカラーが変わる様に設定
